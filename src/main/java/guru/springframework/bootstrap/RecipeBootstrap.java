...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.addIngredient(new Ingredient("Dried Oregano", new BigDecimal(1), cupsUom));
        tacosRecipe.addIngredient(new Ingredient("Dried Cumin", new BigDecimal(1), cupsUom));
        tacosRecipe.addIngredient(new Ingredient("Sugar", new BigDecimal(1), cupsUom));
        tacosRecipe.addIngredient(new Ingredient("Salt", new BigDecimal(".5"), cupsUom));
